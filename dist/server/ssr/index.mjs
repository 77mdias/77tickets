...
var client_references_default = {
	"f29e6e234fea": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-BP0Pyj-e.mjs")).export_f29e6e234fea;
	},
	"0deffcb8ffd7": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-BP0Pyj-e.mjs")).export_0deffcb8ffd7;
	}
};
//#endregion
